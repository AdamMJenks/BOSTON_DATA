...
sunlight_hours <- do.call('rbind', lapply(json_list_no_na, function(x) lapply(x['HouseInfoResponse'], function(y) lapply(y[8], function(z) z[6]))))
sqft_available <- do.call('rbind', lapply(json_list_no_na, function(x) lapply(x['HouseInfoResponse'], function(y) lapply(y[8], function(z) z[7]))))
